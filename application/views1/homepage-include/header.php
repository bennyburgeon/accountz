...
<div class="top-header">
    ...
    <div class="container">
       ...
       <div class="col-md-6 col-sm-12">
           ...
           <a href="<?php echo $this->config->base_url();?>index.php/home"><i class="fa fa-envelope "></i>  jobs@acountz.com  </a> <a href="<?php echo $this->config->base_url();?>index.php/home"> <i class="fa fa-mobile"></i> WhatsApp : +971 50 3860610</a>  </div>        
        ...
        <ul class="social-icons">
                     ...
                     <li><a class="facebook" target="_blank" href="http://facebook.com/acountzcom"><i class="fab fa-facebook-f"></i></a></li>

                      <li><a class="facebook" target="_blank" href="http://linkedin.com/company/acountz"></i></a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="utf-banner-headline-text-part">
             ...
             <h3>Accounts & Finance Jobs and Careers in the UAE</h3>
               ...
               <div class="col-md-12">
                  ...
                  <ul class="intro-stats margin-top-45 hide-under-992px">
					...
					<li><a href="<?php echo $this->config->base_url();?>index.php/home"><strong class="counter">All Jobs</strong></a> </li>
           			<li><a href="<?php echo $this->config->base_url();?>index.php/home?func_id=41"><strong class="counter">Accounts Jobs</strong></a> </li>
					<li><a href="<?php echo $this->config->base_url();?>index.php/home?func_id=59"><strong class="counter">Finance Jobs</strong></a> </li>
                     <li><a href="<?php echo $this->config->base_url();?>index.php/home?func_id=22"><strong class="counter">Audit/Tax Jobs</strong></a> </li>
