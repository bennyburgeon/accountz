      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-sm-12 col-md-6">
            ...
            <p class="text-justify">Acountz.com provides employers with human capital solutions that result in measurably improved employee and organizational performance while minimizing employment practice risk.</p>
     ...
     <div class="card card-signin ">
                                 ...
                                 <div class="card-body">
                                    ...
                                    <form class="form-signin">
                                       ...
                                       <button onclick="window.location='<?php echo $this->config->base_url();?>index.php/empsignup'" class="btn btn-lg btn-primary btn-block text-uppercase" type="button">Are you searching for candidates ? click here </button>
                                    ...
                                    acountz.com is a job protal exculively for the employers and candidates in the Logistics and Supply Chain Sectors in UAE, managed by SeekersHR. Employers can post the job and get the right candidates easily and quickly as the portal is having only the screened candidates from this specific industry. 
