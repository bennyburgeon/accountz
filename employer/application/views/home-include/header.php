...
<header id="header" class="sticky-style-2">
  <div class="container clearfix"> 
    ...
    <!-- Logo
				============================================= -->
    <div id="logo"> <a href="<?php echo $this->config->base_url();?>index.php/home" class="standard-logo" data-dark-logo="<?php echo $this->config->base_url();?>images/logo-dark.png"> <img src="<?php echo $this->config->base_url();?>images/logo.jpeg" alt="<?php echo $this->config->item('company_name'); ?>"> </a> </div>
    <!-- #logo end -->
